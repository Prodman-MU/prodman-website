  ...
  return (
    <section id="community" className="section">
      <div className="container">
        ...
        <h2 className="section__heading">Don&rsquo;t Just Watch Products Evolve. Be Part of What&rsquo;s Next.</h2>
          ...
          <article className={`card ${styles.card} ${styles.newsletter}`}>
            ...
            {status === "submitted" ? (
              <p className={styles.microcopy}>
                Newsletter signups are launching soon — join the WhatsApp community above for updates in
                the meantime.
              </p>
            ) : (
              <form
