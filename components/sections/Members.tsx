  ...
  return (
    <section id="members" className="section">
      <div className="container">
        ...
        <h2 className="section__heading">The people behind ProdMan.</h2>
        ...
        <div className={styles.grid}>
          {members.map((member) => (
            <article key={member.name} className={`card ${styles.card}`}>
          ...
          <div className={`card ${styles.moreCard}`}>
            <p>
              Our President, Vice President, and the rest of the core team&rsquo;s profiles are on the
              way.
            </p>
          </div>
        </div>
