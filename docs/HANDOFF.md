...
- ~~Full core-member roster (President/VP + rest of core team) still missing bios/photos.~~ **Resolved 2026-08-09**: roster is 7 members and every member has a photo. The project owner confirmed Sai Harsha Sadhu as President, Akhil Menon as Vice President, and the remaining five people as Members. The source still lacks Supriya’s full name/socials and email addresses for Anusha, Supriya, and Om, so those unverified card actions are intentionally omitted.
